...
Shader "FlameKeeperStandard/RampLitSurfaceRange"
{
	Properties
	{
	...
	CGPROGRAM
		...
		fixed4 frag_surf(v2f_surf IN) : SV_Target 
		{
			...
			c += LightingStandardToneMappedGI(o, worldViewDir, gi);
...
CGPROGRAM
									...
									/* UNITY: Original start of shader */
												...
												float4 ramp = tex2D(_RampTex, float2(a, a));
